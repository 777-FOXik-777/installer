...
while True:
    ...
    res()
    print(Fore.GREEN+"    [11] CamHacker  ("+CamHacker+""+Fore.YELLOW+")  >>  Фото фишинг")
    print(Fore.GREEN+"    [12] VidPhisher ("+VidPhisher+""+Fore.YELLOW+")  >>  Видео фишинг")
    print(Fore.GREEN+"    [13] Telephish  ("+Telephish+""+Fore.YELLOW+")  >>  Фишинг в тг (1)")
    print(Fore.GREEN+"    [14] Dnnme2     ("+Dnnme2+""+Fore.YELLOW+")  >>  Фишинг в тг (2)")
    print(Fore.GREEN+"    [15] Discord    ("+Discord+""+Fore.YELLOW+")  >>  Генератор Nitro")
    res()
