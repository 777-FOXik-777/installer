...
while True:
    ...
    if inp == '11':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/777-oleg-777/PhoneInfoga')
    ...
    if inp == '12':
        ...
        if os.path.exists(filename):
            ...
            res()
            print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] Holehe позволяет узнать регистрации почты")
            res()
    ...
    if inp == '13':
        ...
        if os.path.exists(filename):
            ...
            res()
            time.sleep(1)
            os.system('git clone --depth 1 https://github.com/rajkumardusad/IP-Tracer.git')
            os.chdir('IP-Tracer')
            ...
            res()
            print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] IP-Tracer позволяет узнать инофрмацию о IP")
            res()
    ...
    if inp == '14':
        ...
        if os.path.exists(filename):
            ...
            res()
            print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] Sherlock позволяет найти аккаунт по нику")
            res()
            ...
            res()
            os.system('git clone --depth 1 https://github.com/sherlock-project/sherlock.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '15':
        ...
        if os.path.exists(filename):
            ...
            os.system('rm -fr /data/data/com.termux/files/home/Installer_Files/trash/h8mail')
            os.system('clear')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            ...
            res()
            print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] H8mail позволяет узнать пароль от почты из баз")
            res()
            print(Style.BRIGHT,Fore.GREEN+"["+Fore.CYAN+"!"+Fore.GREEN+"] Пример почты:"+Fore.CYAN+" testoleg@gmail.com")
            res()
            print(Style.BRIGHT,Fore.RED+"[e] Выход")
    ...
    if inp == '16':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/777-oleg-777/mmail')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '17':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/logicguy1/Discord-Nitro-Generator-and-Checker.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '19':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/thewhiteh4t/seeker.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
