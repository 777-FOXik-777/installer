...
while True:
    ...
    print (Fore.GREEN+"\n                                     ╔═════════════╗")
    print (Fore.CYAN+'    [77] поддержка автора            '+Fore.GREEN+'║>утилиты<'+Fore.CYAN+'[91]'+Fore.GREEN+'║')
    print (Fore.CYAN+'    [66] тг канал автора             '+Fore.GREEN+'║'+Fore.RED+' забавы [92]'+Fore.GREEN+'║')
    print (Fore.CYAN+'    [99] обновить[BETA]              '+Fore.GREEN+'║'+Fore.RED+' файлы  [93]'+Fore.GREEN+'║')
    print (Fore.CYAN+'    [00] выход                       '+Fore.GREEN+'╚═════════════╝')
    res()
