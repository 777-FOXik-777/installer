...
print(Style.RESET_ALL)
print(' Этот инструмент предназначен только для образовательных \n целей. Если вы используете Installer для других целей, \n кроме образования, в таких случаях мы не несем ответственности. \n Все утилиты и файлы взяты из открытых источников. Утилиты, \n фото, видео и прочие файлы принадлежат их законным авторам.')
time.sleep(2)
