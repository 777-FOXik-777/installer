...
while True:
    ...
    if inp == '11':
        ...
        if os.path.exists(filename):
            ...
            res()
            print(Style.BRIGHT,Fore.GREEN+"["+Fore.CYAN+"!"+Fore.GREEN+"] Пример в формате E164:"+Fore.CYAN+" +3396360XXXX")
            res()
    ...
    if inp == '12':
        ...
        if os.path.exists(filename):
            ...
            res()
            print(Style.BRIGHT,Fore.GREEN+"["+Fore.CYAN+"!"+Fore.GREEN+"] Пример:"+Fore.CYAN+" testoleg@gmail.com")
            res()
            print(Style.BRIGHT,Fore.YELLOW+"[e] Выход")
            res()
    ...
    if inp == '13':
        ...
        if os.path.exists(filename):
            ...
            if tru_801 == '2':
                ...
                print(Style.BRIGHT,Fore.CYAN+"[IP-Tracer]")
                res()
                print(Style.BRIGHT,Fore.GREEN+"["+Fore.CYAN+"!"+Fore.GREEN+"] Пример:"+Fore.CYAN+" 33.73.133.137")
                res()
    ...
    if inp == '14':
        ...
        if os.path.exists(filename):
            ...
            res()
            print(Style.BRIGHT,Fore.GREEN+"["+Fore.CYAN+"!"+Fore.GREEN+"] Пример:"+Fore.CYAN+" oleghka")
            res()
            print(Style.BRIGHT,Fore.YELLOW+"[e] Выход")
            res()
