...
while True:
    ...
    if inp == '21':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/Devil-Tigers/TigerVirus.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '22':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/777-oleg-777/hammer')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '23':
        ...
        if os.path.exists(filename):
            ...
            if tru_501 == 'y':
                ...
                print(Style.BRIGHT,Fore.CYAN+"[Noisy]")
                print(Fore.WHITE+'', Style.BRIGHT)
                print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] Закрыть Noisy: "+Fore.RED+"Ctrl + C")
                print(Fore.WHITE+'', Style.BRIGHT)
            ...
            res()
            os.system('git clone --depth 1 https://github.com/777-oleg-777/noisy.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '24':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/KasRoudra/k-fuscator.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
