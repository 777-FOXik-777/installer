...
while True:
    ...
    pri()
    baner()
    print(Style.BRIGHT, Fore.CYAN+"\n [Telegram: @SYPEXHACK]                         ["+Fore.YELLOW+"2.10.3"+Fore.CYAN+"]")
    res()
    print(Fore.GREEN+"    [11] CamHacker  >>  Фото фишинг")
    print(Fore.GREEN+"    [12] VidPhisher >>  Видео фишинг")
    print(Fore.GREEN+"    [13] Telephish  >>  Фишинг в тг (1)")
    print(Fore.GREEN+"    [14] Dnnme2     >>  Фишинг в тг (2)")
    print(Fore.GREEN+"    [15] Discord    >>  Генератор Nitro")
    print(Fore.GREEN+"    [16] ShortUrl   >>  Сокращение ссылок")
    print(Fore.GREEN+"    [17] PhoneInfo  >>  Инфо о номере")
    print(Fore.GREEN+"    [18] Holehe     >>  Инфо о почте")
    print(Fore.GREEN+"    [19] Sherlock   >>  Найти по нику")
    res()
