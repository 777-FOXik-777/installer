...
***Installer - это скрипт, который подберет для тебя более 25 отличных хакерских утилит в Termux с автоматической установкой. Для работы этого инструмента НЕ нужны root-права.***
...
- Некторые утилиты на старых версия Installer могут некорректно работать или вовсе не работать. Обновите Installer до последней версии для более комфортного использования.
