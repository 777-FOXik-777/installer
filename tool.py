...
while True:
    ...
    res()
    print(Fore.GREEN+"    [1] Ngrok      ("+Ngrok+""+Fore.YELLOW+")  >>  Тунелирование")
    print(Fore.GREEN+"    [2] Localhost  ("+Localhost+""+Fore.YELLOW+")  >>  Тунелирование")
    print(Fore.GREEN+"    [3] PyPhiser   ("+PyPhisher+""+Fore.YELLOW+")  >>  Фишинг")
    print(Fore.GREEN+"    [4] Zphisher   ("+Zphisher+""+Fore.YELLOW+")  >>  Фишинг")
    print(Fore.GREEN+"    [5] K-fuscator ("+Kfuscator+""+Fore.YELLOW+")  >>  Зашифровать код")
    print(Fore.GREEN+"    [6] TigerVirus ("+TigerVirus+""+Fore.YELLOW+")  >>  Вирусы apk")
    print(Fore.GREEN+"    [7] Maskphish  ("+Maskphish+""+Fore.YELLOW+")  >>  Замаскировать ссылку")
    print(Fore.GREEN+"    [8] IP-Tracer  ("+IPTracer+""+Fore.YELLOW+")  >>  Пробив по IP")
    print(Fore.GREEN+"    [9] Seeker     ("+Seeker+""+Fore.YELLOW+")  >>  Узнать местоположения")
    res()
