...
while True:
    ...
    if inp == '5':
        ...
        while True:
          ...
          res()
          print(Style.BRIGHT, Fore.YELLOW+"[01] Ngrok       ("+Ngrok+""+Fore.YELLOW+")     [16] Скоро...    ("+ShortUrl+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[02] Localhost   ("+Localhost+""+Fore.YELLOW+")     [17] Скоро...    ("+PhoneInfoga+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[03] PyPhiser    ("+PyPhisher+""+Fore.YELLOW+")     [18] Скоро...    ("+Holehe+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[04] Zphisher    ("+Zphisher+""+Fore.YELLOW+")     [19] Скоро...    ("+Sherlock+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[05] CamHacker   ("+CamHacker+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[06] VidPhisher  ("+VidPhisher+""+Fore.YELLOW+")     [21] Скоро...    ("+CamHacker+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[07] Telephish   ("+Telephish+""+Fore.YELLOW+")     [22] Скоро...    ("+VidPhisher+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[08] Dnnme2      ("+Dnnme2+""+Fore.YELLOW+")     [23] Скоро...    ("+Telephish+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[09] Maskphish   ("+Maskphish+""+Fore.YELLOW+")     [24] Скоро...    ("+Dnnme2+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"                         [25] Скоро...    ("+Discord+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[11] Скоро...    ("+CamHacker+""+Fore.YELLOW+")     [26] Скоро...    ("+ShortUrl+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[12] Скоро...    ("+VidPhisher+""+Fore.YELLOW+")     [27] Скоро...    ("+PhoneInfoga+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[13] Скоро...    ("+Telephish+""+Fore.YELLOW+")     [28] Скоро...    ("+Holehe+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[14] Скоро...    ("+Dnnme2+""+Fore.YELLOW+")     [29] Скоро...    ("+Sherlock+""+Fore.YELLOW+")")
