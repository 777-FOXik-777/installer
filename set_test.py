...
while True:
    ...
    if inp == '5':
        ...
        while True:
          ...
          res()
          print(Style.BRIGHT, Fore.YELLOW+"[1] Ngrok       ("+Ngrok+""+Fore.YELLOW+") [11] CamHacker     ("+CamHacker+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[2] Localhost   ("+Localhost+""+Fore.YELLOW+") [12] VidPhisher    ("+VidPhisher+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[3] PyPhiser    ("+PyPhisher+""+Fore.YELLOW+") [13] Telephish     ("+Telephish+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[4] Zphisher    ("+Zphisher+""+Fore.YELLOW+") [14] Dnnme2        ("+Dnnme2+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[5] K-fuscator  ("+Kfuscator+""+Fore.YELLOW+") [15] Discord       ("+Discord+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[6] TigerVirus  ("+TigerVirus+""+Fore.YELLOW+") [16] ShortUrl      ("+ShortUrl+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[7] Maskphish   ("+Maskphish+""+Fore.YELLOW+") [17] PhoneInfo     ("+PhoneInfoga+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[8] IP-Tracer   ("+IPTracer+""+Fore.YELLOW+") [18] Holehe        ("+Holehe+""+Fore.YELLOW+")")
          print(Style.BRIGHT, Fore.YELLOW+"[9] Seeker      ("+Seeker+""+Fore.YELLOW+") [19] Sherlock      ("+Sherlock+""+Fore.YELLOW+")")
          res()
