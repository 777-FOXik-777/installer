...
- Termux из Google Play может не коректно работать. Лучше скачать последний [Termux](https://t.me/SYPEXHACK_fail/51)
- Некторые утилиты на старых версия Installer могут не коректно работаеть. Обновите Installer до последней версии.
