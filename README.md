...
<p align="center">
  <img src="https://img.shields.io/badge/Версия-2.10.1-cyan?style=flat-square">
...
- Если у вас ошибка во время установки попробуйте обновить список пакетов командой: apt update && apt upgrade -y
...
Все утилиты и файлы взяты из открытых источников. Утилиты, фото, видео и прочие файлы принадлежат их законным авторам.***
