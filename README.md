...
- Если утилита не запускается но пишет: ***Утилита уже установлена!***, то её необходимо удалить в настройках Installer. После этого утилиту можно заново установить и запустить.
